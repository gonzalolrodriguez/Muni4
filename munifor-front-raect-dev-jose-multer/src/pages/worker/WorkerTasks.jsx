      ...
      <div className="flex flex-col gap-6">
        ...
        {!currentTask ? (
          ...
          >
            ...
            <span className="px-5 py-2 rounded-full text-base font-medium bg-cyan-100 text-cyan-700 drop-shadow">
        ...
        {futureTasks.length === 0 ? (
          ...
          futureTasks.map((task, idx) => (
            ...
            >
              <span className="block text-base font-semibold text-cyan-700">
                {task.title}
              </span>
              <span className="px-5 py-2 rounded-full text-base font-medium bg-cyan-100 text-cyan-700 drop-shadow">
        ...
        {!selectedTask ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border border-cyan-200 w-full">
            ...
            <div className="mb-2">
              ...
              <span className="ml-2 text-cyan-700 font-mono">
                {selectedTask._id}
              </span>
            </div>
