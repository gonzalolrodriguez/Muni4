        ...
        {!currentCrew ? (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span className="px-4 py-1 rounded-full text-sm font-medium bg-green-100 text-green-700 drop-shadow">
                Activo
              </span>
              {/* //! Badge "Líder" si el usuario es el líder del equipo */}
              {currentCrew.leader === user._id && (
                <span className="px-4 py-1 rounded-full text-sm font-medium bg-cyan-100 text-cyan-700 drop-shadow">
                  Líder
                </span>
              )}
            </div>
        ...
        {pastCrews.length === 0 ? (
          ...
          pastCrews.map((crew, idx) => (
            ...
            >
              ...
              <span className="px-4 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700 drop-shadow">
                Inactivo
              </span>
            </div>
          ))
      ...
      <div>
        ...
        {!selectedCrew ? (
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border border-cyan-200 w-full">
            ...
            {/* //? Líder del equipo */}
            <div className="mb-4">
              <span className="font-semibold text-cyan-700 block mb-2">
                Líder:
              </span>
